...
$tinybrowser['path']['image'] = '/uploads/artigos/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/uploads/artigos/'; // Media files location
$tinybrowser['path']['file']  = '/uploads/artigos/'; // Other files location
