...
<?php  
 if (isset($_POST['sendForm'])) 
 {
     ...
     }else
     {
        ...
        create('cat',$f);
        $_SESSION['return'] = '<span class="alert alert-success">Menu criado com sucesso!</span>';
        header('Location: index2.php?exe=posts/cad-menu');
     }     
        ...
        <form name="formulario" action="" class="form-horizontal" method="post">
         <fieldset>
            ...
            <div class="control-group">	  
                ...
                <input type="submit" value="Criar Menu" name="sendForm" class="btn btn-primary" />
                </div>
            </div>          
         </fieldset>    
        </form>	
